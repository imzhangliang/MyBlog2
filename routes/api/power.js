...
//新增权限
router.power('/addPower', function(req, res, next){
...
//编辑权限
router.power('/editPower', function(req, res, next){
...
//删除权限
router.power('/deletePower/:id', function(req, res, next){
...
//获取权限分页列表
router.power('/powerList', function(req, res, next){
